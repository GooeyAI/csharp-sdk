...
public class AiBackgroundChangerClient
{
    ...
    public async Task<ImageSegmentationPageResponse> ImageSegmentationAsync(
    ...
    )
    {
        ...
        {
            return JsonSerializer.Deserialize<ImageSegmentationPageResponse>(responseBody)!;
        }
        throw new Exception(responseBody);
    }

    public async Task<AsyncApiResponseModelV3> AsyncImageSegmentationAsync(
        ImageSegmentationPageRequest request
    )
    {
        var response = await _client.MakeRequestAsync(
    ...
    public async Task<ImageSegmentationPageStatusResponse> StatusImageSegmentationAsync(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            return JsonSerializer.Deserialize<ImageSegmentationPageStatusResponse>(responseBody)!;
        }
        throw new Exception(responseBody);
    }
}
