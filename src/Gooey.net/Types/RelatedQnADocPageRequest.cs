...
public record RelatedQnADocPageRequest
{
    ...
    public RelatedQnADocPageRequestEmbeddingModel? EmbeddingModel { get; init; }
    ...
    public RelatedQnADocPageRequestSelectedModel? SelectedModel { get; init; }
    ...
    public RelatedQnADocPageRequestCitationStyle? CitationStyle { get; init; }
