...
public record RelatedQnAPageRequest
{
    ...
    public RelatedQnAPageRequestSelectedModel? SelectedModel { get; init; }
    ...
    public RelatedQnAPageRequestEmbeddingModel? EmbeddingModel { get; init; }
