...
[JsonConverter(
    typeof(StringEnumSerializer<QrCodeGeneratorPageRequestImagePromptControlnetModelsItem>)
)]
public enum QrCodeGeneratorPageRequestImagePromptControlnetModelsItem
{
